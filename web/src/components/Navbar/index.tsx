...
export default function Navbar() {
  ...
  return (
    <header className={` transition-all duration-1000  ${pegarTema === "dark" ? "bg-[#202020] text-white" : "bg-[#CEF3FF]"
      ...
      <div className={`flex h-[60%] gap-5 sm:gap-12  justify-end sm:items-center  w-[60%] xl:w-[23%] 2xl:w-[29%] xl:h-[100%]  2xl:px-10  sm:w-[28%]  transition-all duration-1000 ${pegarTema === 'dark' ? "bg-[#202020] xl:bg-black" : "bg-[#CEF3FF] xl:bg-[#BBE6F4]"}`}>
