...
export default function Register() {
  ...
  return (
    ...
    {pegarTypeUser === "Ong" ? (
    <>
     <div className={`transition-all duration-1000  w-full h-[100vh]  sm:h-[91vh] lg:h-[100%] xl:h-[91vh]  flex flex-col items-center justify-center gap-3  sm:gap-9 
    ...
    <>
     <div className={`transition-all duration-1000  w-full h-[100%] flex flex-col items-center justify-center gap-8 sm:gap-9  
        ${pegarTema === "dark" ? "bg-[#202020] text-white" : "bg-[#CEF3FF]"}
        `}>
            ...
            <div className='flex flex-col gap-3 sm:gap-4  w-[80%] justify-center items-center sm:w-[100%] '>
            <div className='flex gap-2 flex-col '>
