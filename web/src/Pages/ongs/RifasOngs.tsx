    ...
    >
      ...
      >
        <div className="flex flex-col w-full">
          <label htmlFor="imgRifa">Imagem do Prêmio da Rifa</label>
        ...
        <div className="flex flex-col w-full">
          <label htmlFor="descricaon">Descrição da Rifa</label>
          <div className="w-full border-purple-500 border-[1px] flex items-center justify-center h-[8vh] rounded-2xl transition shadow-purple-300 shadow-md hover:shadow-lg hover:shadow-purple-500">
            <input
              name="descricaon"
              type="text"
        ...
        <div className="flex flex-col w-full">
          <label htmlFor="preco">Preço do Número de Cada Rifa</label>
          <div className="w-full border-purple-500 border-[1px] flex items-center justify-center h-[8vh] rounded-2xl transition shadow-purple-300 shadow-md hover:shadow-lg hover:shadow-purple-500">
            <input
              name="preco"
              type="number"
